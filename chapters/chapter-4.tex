...
influence the ecosystems they inhabit with their abundance, biomass \cite{bar2018biomass} and metabolism.
...
to insect attack \cite{plant-insect-soil2023}.


Bacteria \cite{Delgado-Baquerizo-atlas}

Nematodes \cite{vandenHoogen2019}

Earthworms \cite{Phillips2021}

Arthropods \cite{milo-arthropods}

Springtails \cite{potapov2023Globally}

Plant traits and soil microbiome interaction \cite{beugnon2022Abiotic}

All of these life forms occur side by side and influence on another. This is visible in the 
top of the mountains \cite{winkler2018side}
