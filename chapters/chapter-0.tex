...
Ecosystem ecology principles \cite{Chapin_Matson_Vitousek_2011} and terrestrial
ecology. 

Comprehension of ecosystem function is one of the pinnacles of ecology and
requires quantitative and conceptual advances \cite{Chapin_Matson_Vitousek_2011}.
...
\cite{hooperEFFECTSBIODIVERSITYECOSYSTEM2005, loreau2001Biodiversity}
and community structure and dynamics \cite{gonze2018Microbial,morris2020linking}
...
environment regarding sequences, proteins and small molecules \cite{shaffer2022Standardized}.
System biology has been established as a means to study community ecology interactions spanning
from the molecular level to the community level \cite{raes2008molecular}.
One area that has emerged from omics analyses is microbial ecology and
consequently the metabolic processes of ecosystems \cite{perez_garcia2016Metabolic}
which unify all living scales, their diversity and complex dynamics \cite{smith2016Origin}.
Microbes are claimed to be one of the major drivers of ecosystem metabolic
processes of all kinds \cite{falkowski2008microbial,hall2018understanding} and
their percentage in total biomass is enormous, comparable to plants \cite{bar2018biomass}.
These discoveries make microbes and microbiomes perfect candidates when
studying ecosystem function \cite{klitgord2011Ecosystems,widder2016Challenges}.

Microbial ecology brought together all scales of ecosystem functioning, from
molecules to biogeochemical cycles \cite{hall2018understanding,kempes2012Growth,raes2011molecular}.
...
implemented in microbial ecology \cite{jiang2016Microbiome}. This integration
...
information from publications \cite{jensen2006Literature}. Microbiome and
human diseases research as stated in \cite{badal2019Challenges} have been
...
function \cite{graham2016Microbes,muller2018Using, perez_garcia2016Metabolic}.
Microbial interactions can be inferred from the aforementioned data as shown
in \cite{machado2021Polarization} based on their habitat and metabolism.
These community dynamics can be used to build ecosystem level metabolic
networks \cite{perez_garcia2016Metabolic} that influence nutrient cycling in
ecosystems \cite{bauer2018Network}. Another approach is by using species as a
container of pathways and then examining the functions accumulated in the
ecosystem \cite{loucaDecouplingFunctionTaxonomy2016}. Both approaches have
...
especially plants \cite{thompson2012Food}. But viruses as well because they
change the metabolic processes of microbes and are highly important in
ecosystem functions \cite{hurwitz2016Viral}. Another restriction is the fact
...
regarding bioenergetics \cite{kempes2012Growth}, population dynamics
\cite{gonze2018Microbial}, ecosystem stability \cite{berdugo2020Global} and
metabolic ecology \cite{brown2004METABOLIC} should be incorporated as well to
...
scope like GBIF, OBIS, iDigBio, EOL etc. \cite{feng2022Review}. 
...
remote-sensing data remains a major challenge \cite{feng2022Review}. The challenge
...
the macro scale \cite{heffernan2014}.

Multi omics and communing ecology \cite{jurburg2022community}

Network inferrence and analysis for biogeochemical cycling \cite{jameson2023Network}

Multilayer networks \cite{marine-multilayers}

Metabolism is a scale independant biological process spanning from chemical reactions
to biogeochemical cycles \cite{hall2018understanding}. Bioenergetic models on food 
webs can provide information about energy exchanges in the food webs \cite{valdovinos2023bioenergetic}.

Information theory is a conceptual framework to bring together agents,
their interactions and the flow of information through these interactions \cite{oconnor-information-ecology}.
...
and conservation \cite{cavicchioli2019scientists}. These fields undertake the
...
inspection and inspire immediate action \cite{derocles2018Biomonitoring}.
...
from agriculture and farming \cite{alvarez-silva2017Compartmentalized} to
...
\cite{banerjee2023Soil, lehmann2020concept}. Yet, the pressure poised from human activities
is reducing the ecosystem services \cite{rillig2023Increasing}.
...
\cite{conde-pueyo2020Synthetic}. Using the data and methods described in this
...
soil ecosystems \cite{guerra2021tracking}.
...
\cite{guerra2020Blind}. Knowledge is lacking for specific taxonomic groups and
ecosystems for example the Sahara desert and belowground fauna.
These gaps are crutial to be studied in order to
improve our understanding of soil ecosystems \cite{cameron2018Global}. 
