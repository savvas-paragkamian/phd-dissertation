...
Global Aridity Index and Potential Evapotranspiration Database \parencite{zomer2022version} was included.
...
The handling and analysis of these data was done with the sf and terra R packages \parencite{Pebesma2023}.
...
U-CIE R package was used for coloring 3 dimensional data \parencite{Koutrouli2022}.
Visualisation was implemented with ggplot2 \parencite{wickham_ggplot2_2016} and pheatmap \parencite{Kolde2019}.
The system environment of the analyses had Python 3.11.4, R version 4.3.2 \parencite{rcoreteam}
and Julia language version 1.9.3 \parencite{Julia-2017}.
...
\begin{figure}[hbt!] 
    \centering\includegraphics[width=\columnwidth]{isd_taxonomy_representative_phyla_box_label2_f.png}
...
The diversity and number of taxa across various land use classes, geological categories,
...
The F3 category, represented by 14 samples, contains 5900 taxa and a Shannon index of 4.82.
...
Aridity classes also show varied diversity and number of taxa. The semi-arid class,
...
29,282 associations (787 are negative). Regarding node specific metrics, \textit{Mesorhizobium mediterraneum} 
and \textit{Desertibacter xinjiangensis} have the 
higher strength, i.e sum of link weights, meaning that it receives a lot of 
positive associations. On the contrary, Stenotrophobacter has a lot of 
associations, 35, but the less strenth hence it has many negative associations.
...
in mountain peaks soil microbiomes \parencite{Adamczyk2019}. One profound
result is that soil bacterial biodiversity is very complex, even sites a few meters apart can differ
...
This approach is the one applied here.

In addition, the immediate release and availability of these data and results is crucial for 
taking action.
