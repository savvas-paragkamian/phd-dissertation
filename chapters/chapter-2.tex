...
documents and can be combined with other tools in some of the considered steps.
   ...
   \begin{figure}[h]
      ...
      \caption[Scanned page of the dataset used]{ A screenshot of the dataset used where the structure of the data and metadata provided can be seen (page 180 from \citep{WoRMS:SourceID:40714})}
