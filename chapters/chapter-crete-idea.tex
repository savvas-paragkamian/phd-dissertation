...
The ENA API was used with a POST request containing the bounding box of Crete as a query. This 
...
the data. The request was then approved and was downloaded.
WoSIS has a dedicated Web Feature Service (WFS) that is specialised for spatial data. 
