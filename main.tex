...
\href{https://www.medschool.umaryland.edu/profiles/holm-johanna/}{Prof. Johanna \textsc{Holms}}\\ % Supervisor name - remove the \href bracket to remove the link  
\end{flushright}
\end{minipage}\\[1cm]
...
metagenomics there is a wealth of data in open omics databeses and in the 
literature. Yet, all this information is inhomogenous and spread in separate 
...
Studying ecosystems past and current conditions has made apperent the need for 
...
Mediterrenean is important for climate change studies.
...
In summary, studying ecosystems ecology with conteporary tools and data poses unique 
...
First, I am trully thankful to Dr Kotoulas for introducing me to his HCMR colleagues and
made the connection to begin my PhD.
His true interest in deep scientific and philosophical questions is uplifting. He is constanly
joining people together around the globe while valueing most the creative working environment,
the new generations of scientists. Working with openess and withour borders is an
...
decisions. His deep knowledge in molecular microbiology and thrist for debate inspire for
a collaboting and creative environment.

Prof Ioannis Antoniou thank you for being a consice and sincere mentor. His amazing ability to focus
on the important questions and hold on to information that's relavant, removing the clutter, 
...
My graditude and respect go to all the people of Island Sampling Day project and especially
Lynn Schriml and Johanna Holms. I have learned and continue to learn so much from 
...
stark contranst in what I do in other aspects of my life. Canyoning, Climbing, Caving 
outdoor activities in heights using ropes is truly what brings me peace. Yet the 
amazing questions that come from ecology and the origin of life require theoritical 
...
extreme environments and then, after the increadible bench work of colleagues, analyse 
these data made my heart sing.

Another aspect of being a bioinformatician is working in different projects with 
multiple people. This realisation was a relavation to me and this PhD is the outcome 
...
Starting with PREGO, a data and text mining metagenomic resourse, we developed a 
knowledge base with web interface and Application Programming Interface. PREGO 
is a meta platform, which is based upon open data and standards of metagenomics. 
...
valuable information that is missing from databeses and text mining solutions unearth 
this information. Hence, the PREGO approach allowed to bring the heterogenous
data together in a single knowledge base. 

Apart from the conteporary data and metagenomics, important biodiversity data is 
...
To further highlight the importance of historical data along with conteporary we 
...
The forth and final chapter of this PhD is the Island Sampling Day Crete.
Island Sampling Day (ISD) is a large scale study for the microbial diversity of the
...
PhD in themed issues of Philoshophical Transections of the Royal Society B.
...
with rich history and groundbraking articles.
...
theoritical mathematical models. And lastly is the integration of multiple methods 
and data to describe an ecosystem. This is what I worked mostly on my PhD and 
harversting different types of data, i.e sequences, spatial data, occurrence data, 
...
Microbes also unlocked some processes and fuctions they facilitate in their environments assisting in
categorising them and finding possible one health concerns.
Using text mining we incorporated historical texts and conteporary literature.
