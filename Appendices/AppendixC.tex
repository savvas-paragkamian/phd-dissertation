...
\label{AppendixC} 
   ...
   \begin{figure}[h]
      \centering
      \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/arthropods-fig_hotspots_of_orders.png}
   ...
   \begin{figure}[h]
      \centering
      \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/arthropods-fig_heatmap.png}
...
\label{table:arthropods-tableS1}
\end{table}
